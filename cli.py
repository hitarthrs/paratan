#!/usr/bin/env python3
import argparse
from src.paratan.runner import run_tandem_model, run_simple_model_modular, build_simple_model_only

def main():
    parser = argparse.ArgumentParser(description="Run Paratan model.")
    parser.add_argument("--mode", choices=["simple", "tandem", "build-only"], required=True)
